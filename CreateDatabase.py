...
# Users
db.session.add(User("George Foreman", "george@gmail.com", "abc123", "george.jpg", "True"))
db.session.add(User("Mary Jackson", "mary@gmail.com", "mary123", "mary.jpg", "True"))
db.session.add(User("Peter", "peter@gmail.com", "peter134", "arms.jpg", "True"))
db.session.add(User("Vanna Gentry", "ligula@proinnon.com", "hunter2", "kajsd.jpg", "True"))
db.session.add(User("Amena Armstrong", "dictum@parturientmontes.net", "friedrice33", "mbnss.jpg", "True"))
db.session.add(User("Tarik", "gobble@turkeys.org", "akj22", "notmary.jpg", "True"))
db.session.add(User("Mary's Cousin", "juana@mary.org", "drugsarebad", "alsonotmary.jpg", "True"))
