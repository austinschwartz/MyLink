...
# Users
db.session.add(User("George Foreman", "george@gmail.com", "abc123", "True","george.jpg"))
db.session.add(User("Mary Jackson", "mary@gmail.com", "mary123", "True", "mary.jpg"))
db.session.add(User("Peter", "peter@gmail.com", "peter134", "True", "arms.jpg"))
db.session.add(User("Vanna Gentry", "ligula@proinnon.com", "hunter2", "True", "kajsd.jpg"))
db.session.add(User("Amena Armstrong", "dictum@parturientmontes.net", "friedrice33", "True", "mbnss.jpg"))
db.session.add(User("Tarik", "gobble@turkeys.org", "akj22", "True", "notmary.jpg"))
db.session.add(User("Mary's Cousin", "juana@mary.org", "drugsarebad", "True", "alsonotmary.jpg"))
...
db.session.add(Album("Vacation Photos", 1))
db.session.add(Album("Conspiracy Theories", 4))
db.session.add(Album("Toast Clipart", 1))
db.session.add(Album("Internet Tubes", 2))
db.session.add(Album("Pictures of my cat", 3))
